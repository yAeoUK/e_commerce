...
class Result {
  ...
  Result({this.message,this.sql });


  @override
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) =>
      identical(other, this) || (other is Result && other.message== message&&other.sql==sql);

  @override
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  int get hashCode => runtimeType.hashCode ^ message.hashCode ^ sql.hashCode;
